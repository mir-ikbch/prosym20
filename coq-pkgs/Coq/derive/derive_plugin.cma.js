...
y="Derive",x=141,w="_vendor+v8.10+32bit/coq/plugins/derive/derive.ml",c=ac.jsoo_runtime,d=c.caml_new_string,k=c.caml_register_global;function
...
l=b(f[x][1],c),n=b(f[x][1],i),o=[1,b(C[7],h),n,l],d=g(D[40],o,a),e=m(F[16],E,d,k,0,j),p=e[2],q=e[1];return[1,d,q,p,function(a,b){return[0,a]}]}]}];function
w(e){if(0===e[0])var
