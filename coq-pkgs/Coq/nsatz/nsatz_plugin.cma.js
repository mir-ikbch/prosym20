...
c=w(a+1|0,[0,b]);f(c,a)[1+a]=[0,T];return[1,d,c]}function
...
h=a[1];if(m(f(e,h)[1+h],[0,b])){a[1]=a[1]-1|0;continue}}if(0<=a[1]){if(0===a[1])return f(e,0)[1];if(a[1]===g)return d;var
i=w(a[1]+1|0,[0,b]),j=a[1],l=0;if(!(j<0)){var
c=l;for(;;){var
n=f(e,c)[1+c];f(i,c)[1+c]=n;var
o=c+1|0;if(j!==c){var
...
d=a[2];if(a[1]===e)return c<d.length-1?f(d,c)[1+c]:[0,b]}return 0===c?a:[0,b]}function
o(j,c){if(0===j[0]){var
D=j[1];if(0===c[0])var
...
k=L;for(;;){var
M=v(i,k,c),N=o(v(i,k,j),M);f(C,k)[1+k]=N;var
O=k+1|0;if(p!==k){var
...
a=n;for(;;){var
l=a+d|0,o=f(e,a)[1+a];f(j,l)[1+l]=o;var
p=a+1|0;if(k!==a){var
a=p;continue}break}}return[1,i,j]}}if(m(c,[0,b]))return[0,b];var
h=w(d+1|0,[0,b]);f(h,d)[1+d]=c;return[1,g,h]}function
n(d,c){if(0===d[0]){var
...
a=l;for(;;){var
j=a+1|0,m=f(d,j)[1+j],o=n([0,G(a+1|0)],m);f(h,a)[1+a]=o;var
p=a+1|0;if(i!==a){var
...
k=Q(f(p,l)[1+l]);h[1]=bz;if(1===l){if(1-a(e[15][34],k,bA)){i[1]=i[1]-1|0;if(a(e[15][34],k,bB))h[1]=m;else
...
b=i;for(;;){var
j=f(h,b)[1+b],k=f(e,b)[1+b],l=a(d[6],k,j);f(g,b)[1+b]=l;var
m=b+1|0;if(c!==b){var
...
b=m;for(;;){var
t=f(j,b)[1+b],h=c(d[22],t);if(Z(h,cj))if(Z(h,ck)){var
...
c=i;for(;;){var
j=f(n,c)[1+c],k=f(g,c)[1+c]+j|0;f(e,c)[1+c]=k;var
l=c+1|0;if(d!==c){var
...
m=b[1],n=0===f(l,m)[1+m]?1:0;if(n)var
o=n;else
var
q=b[1],o=0===f(s,q)[1+q]?1:0;d[1]=o;b[1]=b[1]+1|0;continue}if(d[1])return r;var
...
U=f(e[4],l)[1+l],v=af(f(e[4],m)[1+m],U),o=v[1],V=v[3],W=v[2];if(R)if(0!==o){var
...
q(a,d){var
f=c(e[19][12],d),b=n(a),g=o===b?a[1]:l===b?c(m[2],a):a;return c(u[15],[0,g,f])}function
au(f){var
...
z=c(ar[2],d),C=[0,aY(c(k[51],z)),0],f=n(g),D=o===f?g[1]:l===f?c(m[2],g):g;return q(L,[0,D,C]);case
1:var
F=[0,M(c(k[43],b[1])),0],h=n(g),G=o===h?g[1]:l===h?c(m[2],g):g;return q(R,[0,G,F]);case
2:var
H=[0,E(b[1]),0],i=n(g),I=o===i?g[1]:l===i?c(m[2],g):g;return q(V,[0,I,H]);case
3:var
J=b[1],N=[0,E(b[2]),0],O=[0,E(J),N],j=n(g),P=o===j?g[1]:l===j?c(m[2],g):g;return q(S,[0,P,O]);case
4:var
Q=b[1],X=[0,E(b[2]),0],Y=[0,E(Q),X],p=n(g),Z=o===p?g[1]:l===p?c(m[2],g):g;return q(T,[0,Z,Y]);case
5:var
_=b[1],$=[0,E(b[2]),0],aa=[0,E(_),$],r=n(g),ab=o===r?g[1]:l===r?c(m[2],g):g;return q(U,[0,ab,aa]);default:var
s=b[2],ac=b[1];if(0===s){var
ad=[0,aY(K),0],t=n(g),ae=o===t?g[1]:l===t?c(m[2],g):g;return q(L,[0,ae,ad])}var
u=c(k[47],s),af=0;if(a(k[32],u,B))var
e=n(ah),v=o===e?ah[1]:l===e?c(m[2],ah):ah;else
var
v=q(dv,[0,M(u),0]);var
ag=[0,E(ac),[0,v,af]],w=n(g),ai=o===w?g[1]:l===w?c(m[2],g):g;return q(W,[0,ai,ag])}}function
N(g){var
b=c(u[29],g);if(9===b[0]){var
d=b[2];if(1===d.length-1){var
e=d[1],h=b[1],f=n(Y),i=o===f?Y[1]:l===f?c(m[2],Y):Y;if(a(u[80],h,i)){var
...
s=r[1],I=h[1],t=n(X),J=o===t?X[1]:l===t?c(m[2],X):X;if(a(u[80],I,J))var
p=N(s),g=1;else
var
...
b=m;for(;;){if(0<f(e,b)[1+b])a[1]=b;var
q=b+1|0;if(o!==b){var
b=q;continue}break}}if(0===a[1])return[0,d,g];if(d<a[1]){var
i=a[1],n=f(e,i)[1+i];return[0,a[1],n]}if(a[1]===d){var
j=a[1];if(f(e,j)[1+j]<g){var
k=a[1],p=f(e,k)[1+k];return[0,a[1],p]}}return[0,d,g]},p=j(e[17][15],s,dz,b),h=p[2],a=p[1];if(0===a){var
...
t=function(i,g){var
b=g[2],j=g[1],k=i[2],l=i[1];if(h<=f(c(J[1],b),a)[1+a]){var
m=c(J[1],b),d=c(e[19][8],m);d[1+a]=f(d,a)[1+a]-h|0;return[0,[0,[0,j,c(J[2],d)],l],k]}return[0,l,[0,[0,j,b],k]]},q=j(e[17][15],t,dA,b),u=q[2],v=q[1],w=1===h?[1,c(d[22],a)]:aR([0,[1,c(d[22],a)],h]),x=g(c(e[17][9],u));return as([0,aS([0,w,g(c(e[17][9],v))]),x])}return aQ(c(k[43],dB))}return g(b)}function
a2(b,a){function
...
ad=c(e[17][9],t[3]),F=[0,t[4],ad],i=c(e[17][1],F),p=w(i,0),J=function(b){if(!(i<=b))if(!f(p,b)[1+b]){f(p,b)[1+b]=1;var
...
c=(b+a|0)+1|0;return f(p,c)[1+c]}return f(p,b)[1+b]?[0,a(e[17][63],d,c)]:0},b=a(ap[66],S,F);x(function(f){var
